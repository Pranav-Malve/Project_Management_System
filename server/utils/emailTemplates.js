export function generateForgotPasswordEmailTemplate(resetPasswordUrl) {
  ...
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 8px; background-color: #ffffff; color: #1f2937;">
    ...
    <div style="text-align: center; margin-bottom: 20px;">
      <h2 style="color: #3b82f6; margin: 0;">FYP SYSTEM - Password Reset Request Your Password</h2>
      <p style="font-size: 14px; color: #667280; margin: 5px 0 0 0;">
    ...
    <!-- Footer -->
    <footer style="margin-top: 30px; text-align: center; font-size: 14px; color: #667280;">
